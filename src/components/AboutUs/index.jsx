                ...
                <div className="AboutUs__row row">
                    ...
                    <div className="AboutUs__menu col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div className="AboutUs__presentation">
                            <p className="AboutUs__text">Somos una <strong>empresa líder en diseño web y posicionamiento SEO</strong>. Con más de 5 años de experiencia en el mercado, entregando siempre productos de calidad y buen servicio</p>
                        </div>
                    </div>
